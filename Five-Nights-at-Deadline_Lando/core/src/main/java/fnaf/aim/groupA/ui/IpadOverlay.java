    ...
    public void render(SpriteBatch batch) {
        ...
        if (aiEnemies != null && aiEnemies.size > 0) {
            ...
            if (enemyManager != null) {
                Gdx.app.log("Tablet",
                    "enemyCount=" + enemyManager.getEnemies().size +
                        " laneW=" + enemyManager.getLaneWidth() +
                        " laneH=" + enemyManager.getLaneHeight() +
                        " laneX=" + enemyManager.getLaneX() +
                        " laneY=" + enemyManager.getLaneY()
                );
