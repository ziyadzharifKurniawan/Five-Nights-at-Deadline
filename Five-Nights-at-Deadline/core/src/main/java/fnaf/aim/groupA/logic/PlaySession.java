...
public class PlaySession {
    ...
    private int jumpscareEnemyId = 0;
    ...
    public int consumeJumpscareEnemyId() {
        int id = jumpscareEnemyId;
        jumpscareEnemyId = 0;
        return id;
    }
    ...
    public void update(float delta) {
        ...
        int attackedEnemyId = enemyManager.update(delta, phoneOpen, isLeftFlashing(), isRightFlashing());
        if (attackedEnemyId != 0) {
            jumpscareEnemyId = attackedEnemyId;
        }
    }
}
